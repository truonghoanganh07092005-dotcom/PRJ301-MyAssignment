...
public class RequestCancelController extends BaseRequiredAuthenticationController {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp, User user)
        ...
        if (rid > 0 && user != null) {
            new RequestForLeaveDBContext().cancelByOwnerIfInProgress(rid, user.getId());
        }
        goBack(req, resp);
    }
