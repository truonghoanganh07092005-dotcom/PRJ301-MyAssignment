// src/java/controller/request/RejectController.java
...
public class RejectController extends BaseRequiredAuthorizationController {
    ...
    protected void processGet(HttpServletRequest req, HttpServletResponse resp, User user)
        ...
        try {
            ...
            s.setAttribute("flash", ok ? ("ĐÃ TỪ CHỐI đơn #" + rid) :
                                         ("Không thể từ chối đơn #" + rid + " (chỉ khi In Progress & là quản lý trực tiếp)."));
        } catch (Exception ex) {
